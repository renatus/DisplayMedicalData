...
def draw(np, plt, dfBTemp, temperatureByDayMean, temperatureByDayMax, temperatureByDayMin, temperatureMA5, temperatureMA15, temperatureMA100, datetimesNparr, dfMedicationStartStop, dfCycle, dfWellbeing):
    ...
    plt.figure("Wellbeing Line Plot - Part 2")
    ...
    # Plot Xylometazoline usage frequency line graph
    axVaginalBleeding.plot(dfWellbeing['dateTimeTaken'], dfWellbeing['xylometazolineUsage'], label='Xylometazoline usage, times per day', color='r')
    ...
    axVaginalBleeding.set_ylabel('Nasal')
